This fork is used to tackle smaller bugs and dependency problems of this package within our project, since the official repository is no longer maintained.
